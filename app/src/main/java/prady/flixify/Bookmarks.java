...
//                startActivity(intent);
            ...
            case R.id.deleteBook:
                Snackbar snackbar1 = Snackbar.make(coordinatorLayout, "Long press on item to delete", Snackbar.LENGTH_LONG);
                snackbar1.show();
                break;

            case R.id.refreshBook:
                coordinatorLayout.invalidate();
                Snackbar snackbar2 = Snackbar.make(coordinatorLayout, "Refreshed", Snackbar.LENGTH_LONG);
                snackbar2.show();
                break;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout = findViewById(R.id.bookmarkCoordinator);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        Snackbar snackbar1 = Snackbar.make(coordinatorLayout, "Pull Down to refresh!!\nLong press on item to delete!", Snackbar.LENGTH_SHORT);
        snackbar1.show();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (o instanceof Map) {
                    Map map = (Map) o;
                    Intent in = new Intent(Bookmarks.this, BrowserActivity.class);
...
//
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (jsonLink != null && jsonTitle != null) {
                        ...
                        adapter = new SimpleAdapter(Bookmarks.this,
    ...
    private void deleteBookmark(final String title, final String link) {
        ...
        new android.support.v7.app.AlertDialog.Builder(Bookmarks.this)
                .setTitle("DELETE")
...
//        builder.setMessage("Are you sure you want to exit Bookmarks?")
//                .setCancelable(false)
//                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
